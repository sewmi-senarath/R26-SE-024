...
import { SeverityHistoryItem, SeverityLevel } from "@/src/types/dementia.types";
...
<body>
  ...
  <div class="footnote">
    ...
    provided for general context, not a clinical diagnosis. Severity figures are produced by MemoCare's
