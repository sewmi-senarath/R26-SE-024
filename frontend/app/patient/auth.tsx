...
const styles = StyleSheet.create({
  ...
  tagline: { fontSize: 14, color: '#64748b', fontWeight: '600', marginTop: 4 },

  card: {
    backgroundColor: '#1e293b', borderRadius: 28, padding: 28,
    shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 20, elevation: 8
  },
  cardTitle: { fontSize: 22, fontWeight: '900', color: '#f1f5f9', marginBottom: 6 },
  cardSubtitle: { fontSize: 14, color: '#64748b', fontWeight: '500', marginBottom: 24 },
  ...
  input: { flex: 1, paddingVertical: 16, fontSize: 16, color: '#f1f5f9', fontWeight: '700', letterSpacing: 1 },
  ...
  infoBox: { flexDirection: 'row', alignItems: 'center', gap: 6, justifyContent: 'center' },
  infoText: { color: '#475569', fontSize: 11, fontWeight: '500' },

  hint: { textAlign: 'center', color: '#334155', fontSize: 12, marginTop: 32, lineHeight: 18 }
});
